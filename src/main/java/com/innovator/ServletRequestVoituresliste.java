...
@WebServlet("/voituresliste")
public class ServletRequestVoituresliste extends HttpServlet {
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/pageRequetteVoituresliste.jsp").forward(request, response);
    }
