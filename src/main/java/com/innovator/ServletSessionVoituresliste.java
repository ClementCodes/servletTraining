...
public class ServletSessionVoituresliste extends HttpServlet {
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/pageSessionVoituresliste.jsp").forward(request, response);
    }
